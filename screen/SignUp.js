            ...
            >
                <ScrollView>
                    <View style={styles.secContainer}>
                        ...
                        <Text style={{ color: "#fff", marginTop: 15, fontSize: 25 }}>New Member</Text>
                        <View style={{ marginTop: 40, width: "85%", borderBottomColor: "#fff", borderBottomWidth: 2, display: "flex", flexDirection: "row" }}>
                            <Image
                                source={require('../components/assets/full-name.png')}
                        ...
                        >
                            <Text style={{ color: 'white', fontSize: 16 }}>I have an account.Back to login.</Text>
                        </TouchableOpacity>
